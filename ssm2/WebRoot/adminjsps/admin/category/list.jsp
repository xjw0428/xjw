...
<c:forEach items="${categoryList }" var="category" >  
    	<tr bordercolor="rgb(78,78,78)">
    		...
    		<td>
    		  <a href="<c:url value='/admin/editPre.action?cid=${category.cid }'/>">修改</a> |
    		  <a onclick="return confirm('您真要删除该分类吗?')" href="<c:url value='/admin/delete.action?cid=${category.cid }'/>">删除</a>
    		</td>
    	</tr>
  </c:forEach>   	
    </table>
